...
def plot_ordered_similarity_heatmap(
    D,
    y_names=None,
    x_names=None,
    y_order=None,
...
def plot_heatmap_xlabel_colors(x_names, x_order, color_dict, xticklabel_is_id=True):
    ...
    # plot 1D heatmap
    hm = sns.heatmap(
        np.arange(len(xticklabels)).reshape(1, -1),
        ax=ax,
        square=True,
        cmap=color_list,
        cbar=False,
