...
# Author_and_contribution: Meghan Turner; 
...
parser = argparse.ArgumentParser(description="Load data for ABC Mouse Whole-Brain Atlas (https://portal.brain-map.org/atlases-and-data/bkp/abc-atlas), thalamus subset")
