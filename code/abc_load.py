...
def get_combined_metadata(cirro_names=True, flip_y=True, version="20230830"):
    # this info is redundant but includes more cells (QC'ed out of CCF process?) 
    # cells_df = pd.read_csv(
    #     abc_root/f"metadata/MERFISH-C57BL6J-638850/{version}/views/cell_metadata_with_cluster_annotation.csv",
...
def load_adata(with_metadata=True, transform='log2', cirro_names=False, version="20230830", subset_to_ref=True):
